...
function index({ product,quantity, removeFromCart,addItemToCart }: CartItemProps) {
  return (
    <View
      style={{
        width: "100%",
    ...
    >
      ...
      >
        ...
        >
          ...
          <TouchableOpacity onPress={()=> addItemToCart(product.product)} style={{ flex: 1, alignItems: "center" }}>
            <Text
